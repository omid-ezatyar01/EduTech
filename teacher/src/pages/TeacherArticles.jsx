...
export default function TeacherArticles() {
  ...
  const text = {
    ...
    coverTooLarge: language === "fa" ? "تصویر باید کمتر از ۱۰ مگابایت باشد و پس از فشرده‌سازی حداکثر ۳۰۰ کیلوبایت خواهد شد." : "The source image must be under 10 MB and will be compressed to a maximum of 300 KB.",
  ...
  const selectCover = async (event) => {
    ...
    try {
      ...
      updateField("coverImage", await uploadTeacherArticleCover(optimizedFile));
    } catch (err) {
