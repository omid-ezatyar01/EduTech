const toneMap = {
  teal: { bg: "bg-[#CCFBF1]", text: "text-[#00B8A9]" },
  purple: { bg: "bg-[#EDE9FE]", text: "text-[#8B5CF6]" },
  orange: { bg: "bg-[#FEF3C7]", text: "text-[#F59E0B]" },
  green: { bg: "bg-[#DCFCE7]", text: "text-[#10B981]" },
};

export default function TeacherAssignmentStatsCard({ title, value, subtitle, icon: Icon, tone = "teal" }) {
  const color = toneMap[tone] || toneMap.teal;
