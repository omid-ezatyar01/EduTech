...
const regionalPriceSchema = new mongoose.Schema(
  {
    ...
    regularPriceUsd: { type: Number, min: 0, max: 10000, default: null },
    discountedPriceUsd: { type: Number, min: 0, max: 10000, default: null },
    usdExchangeRate: { type: Number, min: 0, max: 1_000_000_000, default: null },
