  ...
  return (
    <div className="grid grid-cols-2 gap-4 md:grid-cols-4">
      {stats.map((stat, idx) => {
        ...
        return (
          <div
            className="flex flex-col items-center justify-center gap-3 rounded-2xl border border-slate-200 bg-white p-5 text-center shadow-[0_12px_35px_rgba(15,23,42,0.03)] transition hover:-translate-y-1 hover:shadow-md"
            key={idx}
          >
