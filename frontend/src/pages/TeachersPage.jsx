        ...
        <div className="mt-4 space-y-8">
          <div className="min-w-0">
            ...
            <div id="teacher-results" className="edutech-scrollbar mt-5 flex snap-x snap-mandatory items-stretch gap-4 overflow-x-auto px-1 pb-3 sm:grid sm:snap-none sm:grid-cols-2 sm:gap-5 sm:overflow-visible lg:grid-cols-3 xl:grid-cols-4">
              {filteredTeachers.map((teacher, index) => <div key={teacher._id || teacher.name} className="w-[min(82vw,280px)] min-w-[min(82vw,280px)] shrink-0 snap-start sm:w-auto sm:min-w-0"><TeacherCard labels={page} teacher={teacher} index={index} rank={index + 1} /></div>)}
            </div>
