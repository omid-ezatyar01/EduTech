...
import { ExternalLink, Image as ImageIcon, Loader2, Pencil, Plus, Trash2, Upload, X } from "lucide-react";
import {
...
const pageCopy = {
  fa: {
    ...
    status: "وضعیت",
    link: "لینک تصویر (اختیاری)",
    linkPlaceholder: "مثال: /packages یا https://example.com",
    linkHelp: "با کلیک کاربر روی تصویر، این لینک باز می‌شود.",
    noLink: "بدون لینک",
    active: "فعال",
    inactive: "غیرفعال",
    save: "ذخیره",
  ...
  en: {
    ...
    linkPlaceholder: "Example: /packages or https://example.com",
    linkHelp: "This link opens when a user clicks the image.",
    noLink: "No link",
    active: "Active",
    inactive: "Inactive",
    save: "Save",
